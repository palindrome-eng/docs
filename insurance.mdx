...
<CardGroup cols="1">
  <Card title="Establishing Innovative Partnerships with ReStaking Platforms." icon="handshake" iconType="regular" color="#00ff00" href="https://x.com/jito_sol/status/1820849416942866827">
  ...
  <Card title="Increased Capital Efficiency for Cash Fund Deployement." icon="money-bill-trend-up" iconType="regular" color="#00ff00">
  ...
  <Card title="Decentralization Bonds" icon="hand-holding-dollar" iconType="regular" color="#00ff00">
  ...
  <Card title="Protocol Owned Insurance (POI)" icon="building-columns" iconType="regular" color="#00ff00">
