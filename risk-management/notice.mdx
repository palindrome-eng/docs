---
title: 'Protocol Risk Assumptions'
description: 'Comprehensive breakdown of Risk Assumptions when depositing into Reflect Protocol'
---

<Info>Be Aware | When utilizing financial primitives online, it is paramount to be comfortable with personal management of operational and economic security and understand all of the risks associated with such a product.</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Funding Rate Exposure" icon="percent">
...
<Accordion title="Full Notice of Risk Assumptions regarding Reflect Protocol." icon="file">
