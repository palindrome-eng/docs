...
<CardGroup cols="2">
  <Card title="Smart Contract Risk" icon="file-code" img="/images/docs-bar.png">
  ...
  <Card title="Exchange Risk" icon="shuffle" img="/images/docs-bar.png">
  ...
  <Card title="Interest Rate Risk" icon="percent" img="/images/docs-bar.png">
  ...
  <Card title="Collateral Risk" icon="sack-dollar" img="/images/docs-bar.png">
