---
title: "Single-Sided Delta-Neutral (USDR)"
...
<CardGroup cols="2">
  <Card title="Smart Contract Risk" icon="file-code" color="#00ff00">
  ...
  <Card title="Exchange Risk" icon="shuffle" color="#00ff00">
  ...
  <Card title="Funding Rate Exposure" icon="percent" color="#00ff00">
  ...
  <Card title="Collateral Risk" icon="sack-dollar" color="#00ff00">
