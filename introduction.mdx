---
title: "Intermediation for Decentralized Finance"
description: "Reflect Money allows for the programmatic creation of yield-bearing stablecoins backed entirely by intermediated productivity. "
---

<CardGroup cols="1">
  <Card title="Welcome to the Reflect Money Documentation" icon="flag-usa" iconType="light" color="#00ff00" img="/tokenise-expanses.png">
...
<CardGroup cols="1">
  <Card title="Programmable USD" icon="coins" iconType="regular" color="#00ff00">
  ...
  <Card title="Issue & Redemption Programs" icon="building-columns" iconType="regular" color="#00ff00">
  ...
  <Card title="Verifiable Insurance Programs" icon="shield" iconType="regular" color="#00ff00">
  ...
  <Card title="Monetary Expanse Index (MEI)" icon="layer-group" iconType="regular" color="#00ff00">
