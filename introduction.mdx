...
<CardGroup cols="1">
  <Card title="Welcome to Reflect.Money Documentation" icon="flag-usa" iconType="light" color="#00ff00" img="https://github.com/palindrome-eng/docs/blob/main/images/docs-image-one.png?raw=true">
