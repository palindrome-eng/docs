...
<CardGroup cols="1">
  <Card title="Welcome to Reflect.Money Documentation" icon="flag-usa" iconType="light" color="#00ff00" img="https://github.com/palindrome-eng/docs/blob/main/images/docs-home-image.png?raw=true">
...
<CardGroup cols="1">
  <Card title="Tokenization" icon="coins" iconType="regular" color="#00ff00" img="https://github.com/palindrome-eng/docs/blob/main/images/docs-bar.png?raw=true">
  ...
  <Card title="Decentralized Financial Strategy" icon="layer-group" iconType="regular" color="#00ff00" img="https://github.com/palindrome-eng/docs/blob/main/images/docs-bar.png?raw=true">
  ...
  <Card title="Verifiable Insurance" icon="shield-check" iconType="regular" color="#00ff00" img="https://github.com/palindrome-eng/docs/blob/main/images/docs-bar.png?raw=true">
