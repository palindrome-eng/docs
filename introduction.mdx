...
Reflect is credibly-neutral stablecoin software, where the software consists of insured, decentralized financial strategies executed and managed permissionlessly by programs rather than humans. Reflect then **tokenizes these strategies** in the <u>form of interest-bearing US Dollars</u> (stablecoins).
...
<CardGroup cols="1">
  <Card title="Tokenization" icon="coins" iconType="regular">
  ...
  <Card title="Decentralized Financial Strategy" icon="layer-group" iconType="regular">
  ...
  <Card title="Verifiable Insurance" icon="shield-check" iconType="regular">
