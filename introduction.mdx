...
<CardGroup cols="1">
  <Card title="Programmable USD" icon="coins" iconType="regular" color="#000000">
  ...
  <Card title="Issue & Redemption Programs" icon="building-columns" iconType="regular" color="#000000">
  ...
  <Card title="Verifiable Insurance Programs" icon="shield" iconType="regular" color="#000000">
  ...
  <Card title="Monetary Expanse Index (MEI)" icon="layer-group" iconType="regular" color="#000000">
