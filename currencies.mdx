...
<CardGroup cols="2">
  <Card title="Hedge SOL (Solana)" icon="chart-simple" color="#2e90ff">
    Hedge against price risk by issuing delta-neutral stablecoins with productive SOL based capital (LSTs).
  </Card>
  <Card title="Earn US Dollar Yields" icon="chart-mixed" color="#2e90ff">
  ...
  <Card title="Swap to USD Pegged Fiat" icon="globe" color="#2e90ff">
  ...
  <Card title="Build next-gen fintech" icon="square-code" color="#2e90ff">
