...
The SDK exports one simple module called `RLP`. This class exposes methods for restaking (and unstaking) assets from the RLP, as well as monitoring the pool's health and managing individual positions.
...
### Start earning, claim appreciation with TypeScript
